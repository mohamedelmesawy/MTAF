...
from mtaf.domain_adaptation.eval_video_UDA import evaluate_domain_adaptation
...
def main(config_file, exp_suffix):
    ...
    f = BytesIO()
    IPython.display.display(IPython.display.Image('/content/gdrive/MyDrive/RAM/PRETRAINED_MODELS/MTAF/mtaf/scripts/Segmentation_Mapillary.png'))
    f.close()
    # plt.clf()
    # plt.close()
